...
import lk.kj.kjshop.adapter.CartAdapter;
import lk.kj.kjshop.databinding.FragmentCartBinding;
...
public class CartFragment extends Fragment {
                    ...
                    if (!qds.isEmpty()) {
                        ...
                        adapter.setOnQuantityChangeListener(cartItem -> {
                            ...
                            db.collection("users").document(uid)
                                    .collection("cart")
                                    .document(documentId).update("quantity", cartItem.getQuantity())
    ...
    private void updateTotal() {
        ...
        db.collection("products").whereIn("productId", productIds)
                .get()
